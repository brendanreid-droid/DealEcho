...
import {
  ...
  medianCycle,
  getDealMechanics,
  MIN_MECHANICS_REVIEWS,
  MechanicsReview,
} from "./dealMechanics";

// Ported from services/dealMechanics.test.ts, trimmed to the fields
// MechanicsReview carries. The assertions below are unchanged - they are the
// evidence that the server copy behaves identically to the frontend one.
export const base: MechanicsReview = {
  id: "r1",
...
export const r = (over: Partial<MechanicsReview>): MechanicsReview => ({ ...base, ...over });
