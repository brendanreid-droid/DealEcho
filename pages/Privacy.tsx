        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-3xl rounded-card p-8 md:p-12 shadow-2xl space-y-10 leading-relaxed text-sm md:text-base font-normal">
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-3 text-slate-400">
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  <strong className="text-slate-200">Active Tab Hostname:</strong> The extension reads the domain name (e.g., <em>acme.com</em>) of your current tab when you switch tabs or navigate to a new page. This is held only in temporary browser session storage on your own device and is cleared when you close your browser. It is sent to our servers only while the Side Panel is open, so the panel can refresh company intelligence without requiring manual input. We do not collect full URLs, page titles, page content, or browsing history - only the hostname.
                </li>
                <li>
