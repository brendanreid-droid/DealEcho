        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-4xl">
            <div className="flex items-center space-x-3 mb-6">
              <span className="bg-indigo-600/30 text-indigo-200 text-[10px] font-black uppercase tracking-[0.2em] px-4 py-2 rounded-full border border-indigo-500/20 backdrop-blur-md flex items-center w-fit">
        ...
        {!isPaid ? (
          <div className="bg-white rounded-[48px] border-2 border-slate-200 shadow-xl overflow-hidden relative min-h-[600px]">
            <div className="absolute inset-0 bg-white/80 backdrop-blur-xl z-30 flex flex-col items-center justify-center p-10 text-center">
                <div className="w-20 h-20 bg-[#101426] text-white rounded-[28px] flex items-center justify-center mb-8 shadow-2xl border-b-4 border-indigo-500">
          ...
          <div className="space-y-12 md:space-y-16">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
              ...
              <StatSummaryCard label="Markets" value={industries.length} icon="fa-globe" color="text-indigo-500" />
            </div>
